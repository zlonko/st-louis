...
import { articleLink, highlighter, stepHeading, stepList, stepParagraph } from './typography';
...
export const steps: StepConfig[] = [
  {
    ...
    content: (
      <>
        ...
        <p className={stepParagraph}>
          Charts can help us understand the state of present day St. Louis. Scroll down for a closer look.
        </p>
        <p className={stepParagraph}>
          Source:{' '}
          <a href="https://www.census.gov/programs-surveys/acs" target="_blank" rel="noreferrer" className={articleLink}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>How many people live in St. Louis?</h2>
        <p className={stepParagraph}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>How much do residents make?</h2>
        <p className={stepParagraph}>
        ...
        <p className={stepParagraph}>So, what do we know about the residents themselves?</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>Who lives in St. Louis?</h2>
        <p className={stepParagraph}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>What about Black St. Louisians?</h2>
        <p className={stepParagraph}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>Do race and income interact?</h2>
        <p className={stepParagraph}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>What about poverty?</h2>
        <p className={stepParagraph}>
  ...
  },
  {
    ...
    content: (
      <>
        <h2 className={stepHeading}>Where do we go from here?</h2>
        <p className={stepParagraph}>
        ...
        <h2 className={stepHeading}>Resources</h2>
        <p className={stepParagraph}>To learn more about getting involved, visit these links:</p>
        <ul className={stepList}>
          ...
          <li>
            <a href="https://stlequity.org/" target="_blank" rel="noreferrer" className={articleLink}>
              St. Louis Equity Indicators Project
            </a>
          </li>
          <li>
            <a href="https://helpingpeople.org/our-impact/racial-equity/" target="_blank" rel="noreferrer" className={articleLink}>
        ...
        <p className={stepParagraph}>
          ...
          <a href="https://www.github.com/tblainek/st-louis" target="_blank" rel="noreferrer" className={articleLink}>
            GitHub
          </a>
          .
        </p>
