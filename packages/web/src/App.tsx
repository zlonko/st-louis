        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12">
            ...
            >
              ...
              <p className={stepParagraph}>
                But these basic population counts dn't tell you who stayed, who left, or who was pushed out. That requires a closer look.
              </p>
              <p className="pt-5 italic">
            ...
            >
              <p className={stepParagraph}>
                If we arrange those same census tracts by median household income, we see a clear pattern. County tracts cluster toward the high end. City tracks cluster toward the low end. Select any tract in the City, and the median income is <strong>below $50,000</strong>.
              </p>
              <p className={stepParagraph}>
                This is our economy, one that spent decades building outward and leaving the City to manage its own decline with a shrinking tax base. The wealth didn't just move on its own. We <em>moved</em> it by design.
              </p>
              <p className="pt-5 italic">
                  ...
                  <li key={label} className="flex items-center gap-2">
                    <span
                      ...
                      style={{
                        ...
                        border: i === 0 ? `1px solid ${pocBelowAverageStroke}` : undefined,
                      }}
                      aria-hidden="true"
                    />
                    {label}
            ...
            >
              <p className={stepParagraph}>
                These charts in this article show a region shaped by choice, not fate. Redlining, highway construction, zoning, and municipal fragmentation didn't just happen to St. Louis. They were decisions made by us. By our governments, banks, developers, and neighbors. They can be unmade by us all the same.
              </p>
              <p className={stepParagraph}>
                Our work is already underway. Organizations across the region are pushing for change, from police reform to public school funding to housing policy. If you live here, this is your city, too. This is our moment to stand together.
              </p>
              <ul className="font-sans text-sm text-article-text space-y-2 list-none p-0 m-0">
                <li className="flex items-center gap-2">
